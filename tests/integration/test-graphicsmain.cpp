...
TEST_CASE("Graphics Main Test")
{
    ...
    SUBCASE("Second Scene") {
        ...
        CHECK_MESSAGE(renderer.GetPixel(toppoint, true) == cGreenColor, "toppoint = " << toppoint);
        CHECK_MESSAGE(renderer.GetPixel(botpoint, true) == cGreenColor, "botpoint = " << botpoint);
