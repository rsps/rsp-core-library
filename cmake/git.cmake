...
if(NOT COMMAND "git_get_semver")
    ...
    # with build metadata: <version>[+<sha>[.dirty]]
    #
    # @example
    #       git_get_semver(OUTPUT version WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR})
    #       message("${version}")    # e.g. "1.2.3-rc1+5e6a7de766aeb2a75eaad246e18229afaa7d5046.dirty"
    #
    ...
    #
    # @return
    #     [OUTPUT]                          Semver string, e.g. "1.2.3-rc1+5e6a7de766aeb2a75eaad246e18229afaa7d5046.dirty"
    #
    function(git_get_semver)
        ...
        if(dirty)
            set(full_version "${version}+${sha}.dirty")
        else()
            set(full_version "${version}+${sha}")
        endif()
