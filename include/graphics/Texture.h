...
public:
     ...
     * \param aColor
     */
    virtual Texture& Fill(const Color &arColor, OptionalRect arRect = nullptr) = 0; // NOLINT
     ...
     * \return self
     */
    virtual Texture& Update(const PixelData &arPixelData, const Color &arColor = Color::None) = 0; // NOLINT
     ...
     * \return self
     */
    virtual Texture& SetBlendOperation(BlendOperation aOp, const Color &arColorKey = Color::None) = 0; // NOLINT
    ...
    [[nodiscard]] virtual const Rect& GetSourceRect() const = 0;
    ...
    [[nodiscard]] virtual Point GetDestination() const = 0;
    virtual Texture& SetOffset(const Point &arPoint) = 0;
    [[nodiscard]] virtual Rect GetDestinationRect() const = 0;

    /**
     * \brief Make a safe copy of this texture, possibly referencing the same internal raster storage.
     * \return Texture ptr
     */
    [[nodiscard]] virtual TexturePtr_t Clone() const = 0;
};
