...
protected:
    ...
    Color ReadPixel(const uint8_t* apPixelData, std::uint32_t aX, std::uint32_t aY, size_t aPaddedRowSize);

    static ColorDepth bitsPerPixelToColorDepth(std::uint32_t aBpp);
