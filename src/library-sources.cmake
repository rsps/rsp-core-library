...
elseif (RSP_CORE_LIB_USE_EMBED_HTTP)
    file(GLOB EHTTP_FILES ${CMAKE_CURRENT_LIST_DIR}/network/ehttp/*.cpp)
    list(APPEND NETWORK_FILES ${EHTTP_FILES})
endif()
...
elseif(RSP_CORE_LIB_USE_MBEDTLS)
